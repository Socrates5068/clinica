<x-midone-base>
        ...
        <div class="block xl:grid grid-cols-2 gap-4">
            ...
            <div class="h-screen xl:h-auto flex py-5 xl:py-0 my-10 xl:my-0">
                <div
                    ...
                    <div class="intro-x mt-2 text-slate-400 dark:text-slate-400 xl:hidden text-center">A un par de clicks
                    ...
                    <form class="" method="POST" action="{{ route('register') }}">
                        ...
                        <div class="intro-x mt-8">
                            <input type="text" class="@error('name') border-danger  @enderror  intro-x login__input form-control py-3 px-4 block" id="name"
                                name="name" value="{{ old('name') }}" placeholder="Nombre" 
                                autocomplete="name">

                            <input type="email" class="@error('email') border-danger  @enderror intro-x login__input form-control py-3 px-4 block mt-4"
                            ...
                            <input type="password" class="@error('password_confirmation') border-danger  @enderror intro-x login__input form-control py-3 px-4 block mt-4"
    ...
    <div data-url="{{ route('dark-mode-switcher2') }}" class="dark-mode-switcher cursor-pointer shadow-md fixed bottom-0 right-0 box border rounded-full w-40 h-12 flex items-center justify-center z-50 mb-10 mr-10">
